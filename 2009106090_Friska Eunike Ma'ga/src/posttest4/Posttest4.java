...
public class Posttest4 {
    ...
    public static void main(String[] args) {
        ...
        Gitar Gitar1 = new Gitar("Gitar","Gitar Akustik",2000000,"Steel",6,"Maple");
        Gitar Gitar2 = new Gitar("Gitar","Gitar Classic",1500000,"Nylon",6,"Spruce");
        Gitar Gitar3 = new Gitar("Gitar","Gitar Elektrik",3000000,"Steel",6,"Mahogany");
        
        Bass Bass1 = new Bass("Bass","Bass Akustik",2600000,"Steel",4,"Rosewood");
        Bass Bass2 = new Bass("Bass","Bass Elektrik Senar 4",3000000,"Steel",4,"Mahogany");
        Bass Bass3 = new Bass("Bass","Bass Elektrik Senar 5",4000000,"Steel",5,"Mahogany");

        Piano Piano1 = new Piano("Piano","Grand Piano",95000000,88,"Spruce");
        Piano Piano2 = new Piano("Piano","Piano Digital",13000000,88,"Spruce");
        Piano Piano3 = new Piano("Piano","Keyboard",9000000,61,"Spruce");

        Drum Drum1 = new Drum("Drum","Drum Akustik",12600000,"Birch",7);
        Drum Drum2 = new Drum("Drum","Drum Elektrik",8000000,"Meshed Skin",5);        
